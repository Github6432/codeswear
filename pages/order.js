          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <div className="flex mb-4">
                <a className="flex-grow border-b-2 border-gray-300 py-2 text-lg px-4">Item Description</a>
                <a className="flex-grow border-b-2 border-gray-300 py-2 text-lg px-1 mx-auto">Quantity</a>
                <a className="flex-grow border-b-2 border-gray-300 py-2 text-lg px-1 mx-auto">Item(s) Total</a>
              </div>

              <div className="flex border-t border-gray-200 py-2 ">
                <span className="text-gray-500 ">Wear-the code (XL,Red)</span>
                <span className="text-gray-500 px-8 mx-auto">1</span>
                <span className="ml-auto text-gray-900 px-5 mx-auto">₹499</span>
              </div>
              <div className="flex border-t border-gray-200 py-2">
                <span className="text-gray-500">Wear-the code (XL,Red)</span>
                <span className="text-gray-500 px-8 mx-auto">1</span>
